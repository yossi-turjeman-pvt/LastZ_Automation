...
# Let's try multiple logical X-coordinates for the Rare tab text/background to ensure we hit it!
# Centers: 825, 855, 875
coords = [825, 855, 875, 900]
for x in coords:
    print(f"Clicking at logical (X={x}, Y=387)...")
    click(x, 387)
    time.sleep(0.2)
    # Double click for extra robustness
    click(x, 387)
    time.sleep(0.5)

# Wait and capture screen
time.sleep(1.5)
subprocess.run(["screencapture", "-x", "/tmp/game_screen.png"])
print("Captured screen after robust multi-clicks.")
