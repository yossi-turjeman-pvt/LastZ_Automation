...
# Click perfect coordinates for Rare tab: (895, 395)
print("Clicking Rare tab at (895, 395)...")
click(895, 395)
time.sleep(0.3)
click(895, 395) # double click for robustness

# Wait and capture screen
time.sleep(2)
subprocess.run(["screencapture", "-x", "/tmp/game_screen.png"])
print("Captured screen after perfect click.")
