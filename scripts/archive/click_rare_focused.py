...
# Step 1: Click the window title bar at (756, 45) to guarantee full focus
print("Focusing window by clicking title bar...")
click(756, 45)
time.sleep(0.5)

# Step 2: Click the "Rare" tab at (875, 387)
print("Clicking the Rare tab...")
click(875, 387)

# Step 3: Wait and capture new screen
time.sleep(2)
subprocess.run(["screencapture", "-x", "/tmp/game_screen.png"])
print("Captured screen after focused click.")
