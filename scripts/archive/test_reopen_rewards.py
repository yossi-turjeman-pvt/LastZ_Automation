...
# Click the orange icon at logical (90, 810) to open the modal again
print("Clicking dynamic orange badge icon to see if rewards are still inside...")
click(90, 810)
time.sleep(2)
...
# Crop the middle modal list area
im = Image.open("/tmp/game_screen.png")
im.crop((1100, 800, 1900, 1500)).save("/Users/yossiturjeman/LastZ_Automation/templates/reopen_rewards_list.png")
print("Cropped reopen rewards list area!")
