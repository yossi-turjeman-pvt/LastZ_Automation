...
# Click logical Back Arrow at (575, 900) twice with 3.5 seconds in between to close both windows!
print("Clicking verified logical Back Arrow at (575, 900) to close Alliance Gifts...")
click(575, 900)
time.sleep(3.5) # Wait longer for Gifts window close transition to finish

print("Clicking verified logical Back Arrow at (575, 900) to close Alliance Menu...")
click(575, 900)
time.sleep(3.5) # Wait longer for Alliance Menu close transition to finish

# Safety click on background
click(100, 100)
time.sleep(1.0)
