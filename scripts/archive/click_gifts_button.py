...
# Click the "Alliance Gifts" button at (887, 650) logical coords
click(887, 650)
print("Clicked Alliance Gifts button successfully!")

# Wait and capture new screen
time.sleep(2)
subprocess.run(["screencapture", "-x", "/tmp/game_screen.png"])
print("Captured screen after clicking Alliance Gifts.")
