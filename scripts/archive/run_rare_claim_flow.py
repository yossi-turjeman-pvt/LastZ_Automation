...
# 1. Close any open profiles or modals first by clicking a safe background spot on the left (e.g. 100, 500)
print("Clicking a safe background spot to dismiss any open profiles...")
click(100, 500)
time.sleep(1)

# 2. Click Alliance Shield
print("Clicking Alliance Shield...")
click(1480, 757)
time.sleep(2)

# 3. Click Alliance Gifts
print("Clicking Alliance Gifts...")
click(887, 650)
time.sleep(2)

# 4. Click Rare Tab (950, 390)
print("Clicking Rare Tab...")
click(950, 390)
time.sleep(2)

# 5. Load the green claim button template
...
for attempt in range(max_attempts):
    ...
    if max_val > 0.85:
        ...
        claimed_count += 1
        time.sleep(1.5) # Wait for animation and UI state update
    else:
