...
def click_robust(x, y):
    ...
    time.sleep(0.25) # Slightly longer press time
...
# Click the "Rare" tab at logical coordinates (625, 387)
click_robust(625, 387)
print("Clicked Rare tab robustly!")

# Wait and capture new screen
time.sleep(2)
subprocess.run(["screencapture", "-x", "/tmp/game_screen.png"])
print("Captured screen after robust click.")
