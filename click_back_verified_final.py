...
# Click logical Back Arrow at (612.5, 922.5) twice to close any remaining windows!
print("Clicking verified logical Back Arrow at (612.5, 922.5) to close Alliance Gifts...")
click(612.5, 922.5)
time.sleep(2.5)

print("Clicking verified logical Back Arrow at (612.5, 922.5) to close Alliance Menu...")
click(612.5, 922.5)
time.sleep(2.5)

# Safety click on background (safely in top-left sky, NOT on map center)
print("Clicking top-left sky to clear overlays...")
click(100, 100)
time.sleep(1.0)
